...
export const CTASection = () => {
  ...
  return (
    <div className="mx-auto max-w-7xl"> {/* Tambahkan div pembungkus dengan margin */}
      <section className="bg-gradient-to-r from-orange-500 to-blue-600 rounded-2xl"> {/* Perubahan di sini */}
